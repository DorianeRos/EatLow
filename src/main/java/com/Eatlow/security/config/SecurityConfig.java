...
import com.Eatlow.security.services.impl.NoRedirectStrategy;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	FilterRegistrationBean<TokenAuthenticationFilter> disableAutoRegistration(final TokenAuthenticationFilter filter) {
		final FilterRegistrationBean<TokenAuthenticationFilter> registration = new FilterRegistrationBean<TokenAuthenticationFilter>(
				filter);
