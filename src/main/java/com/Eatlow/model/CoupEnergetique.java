...
public class CoupEnergetique {
	...
	// CONSTRUCTEUR
	public CoupEnergetique(int id, float agriculture, float transformation, float emballage, float transport,
